...
- **Hoàn tác (Ctrl+Z)**: khi đang xem sơ đồ, nhấn `Ctrl+Z` (hoặc `Cmd+Z` trên Mac) để hoàn tác lần kéo thả hoặc lần đổi màu cụm gần nhất — hữu ích khi lỡ tay chạm nhầm bong bóng làm đổi vị trí.
