...
- **Điều chỉnh khoảng cách**: chuột phải vào 1 bong bóng **Supporting** (không phải Pillar) → "Điều chỉnh khoảng cách…" → bảng hiện khoảng cách hiện tại (px) của đúng bong bóng vừa bấm so với Pillar của nó, chỉnh bằng thanh trượt (%) hoặc nhập thẳng số px chính xác mới cho bong bóng đó → Xác nhận. Tỉ lệ tính được sẽ áp dụng cho **mọi bong bóng Supporting khác trong cùng cụm** (mỗi bong bóng dịch ra xa/gần theo đúng hướng hiện tại của nó, không xoay lại vị trí); cụm nào nối chuỗi vào một bong bóng Supporting vừa dịch chuyển (kể cả nối nhiều tầng bên dưới) cũng tự dịch chuyển theo đúng bằng độ dịch đó. Bong bóng Pillar của cụm và mọi cụm khác không liên quan đều đứng yên.
- **Điều chỉnh khoảng trống**: chuột phải vào 1 bong bóng Supporting → "Điều chỉnh khoảng trống…" → nhập số vị trí (≥ số bong bóng Supporting thực tế của cụm) hoặc kéo thanh trượt → Xác nhận. Mọi bong bóng Supporting trong cụm dàn đều quanh Pillar theo đúng số vị trí đó, giữ nguyên thứ tự và khoảng cách tới Pillar của từng bong bóng — chỉ góc thay đổi; chọn số lớn hơn số bong bóng thực tế sẽ để lại khoảng trống (các bong bóng chỉ chiếm một phần vòng tròn) thay vì kín cả vòng. Cụm nào nối chuỗi vào một bong bóng vừa dịch chuyển cũng tự dịch chuyển theo, tương tự Điều chỉnh khoảng cách.
- **Hoàn tác / Làm lại**: khi đang xem sơ đồ, nhấn `Ctrl+Z` (hoặc `Cmd+Z` trên Mac) để hoàn tác lần kéo thả, điều chỉnh khoảng cách/khoảng trống, hoặc đổi màu cụm gần nhất — hữu ích khi lỡ tay chạm nhầm bong bóng làm đổi vị trí. Nhấn `Ctrl+Shift+Z` (hoặc `Cmd+Shift+Z`) để làm lại thao tác vừa hoàn tác.
